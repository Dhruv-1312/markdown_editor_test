...
import 'package:markdown_editor_test/components/editor/keyboard_observer.dart';
...
class CustomToolBar extends StatefulWidget {
  ...
  final List<CustomToolbarItem> Function(
    Selection? selection,
  ) toolbarItemsBuilder;
  final Widget child;
...
class _MobileToolbar extends StatefulWidget {
  ...
  final EditorState editorState;
  final List<CustomToolbarItem> toolbarItems;
  final double toolbarHeight;
...
class _MobileToolbarState extends State<_MobileToolbar>
    implements CustomToolbarWidgetService {
...
class _ToolbarItemListView extends StatefulWidget {
  ...
  final List<CustomToolbarItem> toolbarItems;
  final EditorState editorState;
  final CustomToolbarWidgetService toolbarWidgetService;
...
class _ToolbarItemListViewState extends State<_ToolbarItemListView> {
  ...
  Widget build(BuildContext context) {
    ...
    final children = [
      ...
      ...widget.toolbarItems.asMap().entries.map((entry) {
        final index = entry.key;
        final element = entry.value;
        return [
          element.itemBuilder.call(
            context,
            widget.editorState,
